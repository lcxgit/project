...
(function ($) {
    ...
    $.fn.InputSpinner = function (options) {
        ...
        var config = {
            decrementButton: "<strong><span class='glyphicon glyphicon-minus'></span></strong>", // button text
            incrementButton: "<strong><span class='glyphicon glyphicon-plus'></span></strong>", // ..
