...
<!-- <script src="/Public/sncss/js/cloud.js" type="text/javascript"></script> -->
...
document.getElementById('ip').value= returnCitySN["cip"];
			...
			<ul>
				...
				<tr>
					<td width="42%">
						<input name="verCode" id="verCode" type="text" class="loginuser1" onclick="JavaScript:this.value=''"/>&nbsp;
					</td>
					<td width="58%">
						&nbsp;<img src="/admin.php/Home/login/verify" name="myHeader" height="35" id="myHeader" onclick="this.src='/admin.php/Home/login/verify?'+Math.random();"/>
					</td>
				</tr>
				</table>
				</li>
