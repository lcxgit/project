	...
	<!--会员中心开始-->
		...
		<ul class="dd_list"；style="margin-bottom:80px;">
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><li style="position:relative;">
				...
				<!-- <button style="position:absolute;right:10px;top:50%;margin-top: -15px;font-size: 1em;padding: 5px;background-color: #05B6A3;border: 0px solid #fff;border-radius: 4px;">
