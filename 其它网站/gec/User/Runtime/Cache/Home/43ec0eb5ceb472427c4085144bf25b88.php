...
<body style="background-color: #eee">
	...
	<form action="<?php echo U('/Index.php/Home/Login/register');?>" id="myform" method="post"style="margin-top:20px; margin-bottom:20px;">
		...
		<div style=" margin: 0 auto;width: 94%;background: #fff;border: 1px solid #e3e3e3;border-radius: 5px;">
			...
			<div class="code" style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;">
				...
				<span class="fr" style="background-color: #fe9625;display: inline-block;width: 35%;text-align: center;font-size: 1em;padding: 2px 0px;border-radius: 5px; color:#fff;">发送验证码</span>
			</div>
			<!-- <div  style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;">
		...
		<button type="submit" id="submit"style="margin-left: 5%;width: 90%;height: 2.5em;line-height: 2.5em;font-size: 1em;letter-spacing: 1px;text-align: center;color: #fff;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;background-color: #fe9625;border: 0; margin-top:15px;">注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册</button>
	</form>
</body>
<script>
     function code(){
	   	      ...
	   	      if(pd.test($("#phone").val())){
	   	    	$.ajax({
					url:"<?php echo U('Index.php/Home/Ajax/testmobile');?>",
					type:"POST",
