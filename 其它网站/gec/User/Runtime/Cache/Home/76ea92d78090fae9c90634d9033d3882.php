...
<div style="width: 90%;margin-left: 5%;margin-top: 20px;overflow:hidden;border-radius:5px">
    <p id="qiugoubg"onclick='showhidediv("qiugou")'style="float: left;width: 25%;text-align: center;background-color: #fff;height: 30px;line-height: 30px;">求购</p>
    <p id="chushoubg"onclick='showhidediv("chushou")'style="float: left;width: 25%;text-align: center;background-color: #fe9625;height: 30px;line-height: 30px;color:#fff">出售</p>
    <p id="zzjybg" onclick='showhidediv("zzjy")'style="float: left;width: 25%;text-align: center;background-color: #fe9625;;height: 30px;line-height: 30px;color:#fff">交易</p>
    <p id="ywcjybg" onclick='showhidediv("ywcjy")'style="float: left;width: 25%;text-align: center;background-color: #fe9625;;height: 30px;line-height: 30px;color:#fff">已完成</p>
</div>
<div id="qiugou" style="-left: 5%;margin-bottom:80px;margin-top:30px">
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
            ...
            <li style="width: 20%;"><a href="/Index.php/Home/Info/delqiugou/?id=<?php echo ($v["id"]); ?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">取消</a></li>
            <li style="width: 18%;">
                <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
            </li>
...
<div id="chushou" style="-left: 5%;margin-bottom:80px;margin-top:30px;display: none;width: 90%; margin-left: 5%;">
    ...
    <div>
        <?php if(is_array($cslkb)): foreach($cslkb as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
                ...
                <li style="width: 24%;"><?php echo ($v["lkb"]); ?></li>
                <li style="width: 20%;" class="money"><?php echo ($v["jb"]); ?></li>
                <li style="width: 20%;"><a href="/Index.php/Home/Info/del/?id=<?php echo ($v["id"]); ?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">取消</a></li>
                <li style="width: 18%;">
                    <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                    <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                    <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #fe9625;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
