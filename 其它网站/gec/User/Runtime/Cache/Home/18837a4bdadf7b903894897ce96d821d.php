...
<body>
	...
	<form action="/Index.php/Home/Info/mmgl/" method="POST" style="font-size:14px">
		<ul style="width: 80%;margin-left: 10%;color: #000;padding-top:65px" >
			...
			<li style="margin-top:20px;"><input type="submit" value="完成" style="width: 100%;height: 30px;line-height: 30px;border-radius: 5px;border: 0px; background-color:#fe9625;margin-top: 5px;color: #FFFFFF;-webkit-appearance: none;"/></li>
		</ul>
	</form>
