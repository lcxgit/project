...
<body class="page-mobile ">
        ...
        <ul class="com-columns span2">
		 <li class="comc-item">
                <div class="com-formbox" style="overflow:hidden;display:block;">
							<a href="/Index.php/Home/Login/login/" style="float:left;width:50%;text-align:center;line-height:30px;color:#fe9625;;">中文</a>
	...
	<button id="mysubmit" style="background-color:#fe9625;width:100%;height:47px;line-height:47px;color:#fff;border:0px;border-radius:5px;font-size:16px;">登录</button>
   ...
   <ul>
	...
	<div class="def-p txtr">
		 <a href="/Index.php/Home/User/reg/" class="fz13 link" id="findPwd_btn">注册</a>
    </div>
	</li>
    <!-- 忘记密码 S -->
	<li>
...
<script type="text/javascript" src="j/Public/reg/s/login.js"></script>
