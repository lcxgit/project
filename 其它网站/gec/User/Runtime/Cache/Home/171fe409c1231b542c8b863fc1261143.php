...
<div style="width: 90%;margin-left: 5%;margin-top: 20px;overflow:hidden;border-radius:5px">
    <p id="qiugoubg"onclick='showhidediv("qiugou")'style="float: left;width: 25%;text-align: center;background-color: #fff;height: 30px;line-height: 30px;">求购列表</p>
    <p id="chushoubg"onclick='showhidediv("chushou")'style="float: left;width: 25%;text-align: center;background-color: #05B6A3;height: 30px;line-height: 30px;color:#fff">出售列表</p>
    <p id="zzjybg" onclick='showhidediv("zzjy")'style="float: left;width: 25%;text-align: center;background-color: #05B6A3;;height: 30px;line-height: 30px;color:#fff">交易列表</p>
    <p id="ywcjybg" onclick='showhidediv("ywcjy")'style="float: left;width: 25%;text-align: center;background-color: #05B6A3;;height: 30px;line-height: 30px;color:#fff">已完成列表</p>
</div>
<div id="qiugou" style="-left: 5%;margin-bottom:80px;margin-top:30px">
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
            <li style="width: 18%;height: 30px;overflow: hidden;display: inline-block"><?php echo ($v["p_name"]); ?></li>
            <li style="width: 24%;"><?php echo ($v["lkb"]); ?></li>
            <li style="width: 20%;"class="money"><?php echo ($v["jb"]); ?></li>
            <li style="width: 20%;"><a href="/Index.php/Home/Info/delqiugou/?id=<?php echo ($v["id"]); ?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">取消</a></li>
            <li style="width: 18%;">
                <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
            </li>
...
<div id="chushou" style="-left: 5%;margin-bottom:80px;margin-top:30px;display: none;width: 90%; margin-left: 5%;">
    ...
    <div>
        <?php if(is_array($cslkb)): foreach($cslkb as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
                ...
                <li style="width: 24%;"><?php echo ($v["lkb"]); ?></li>
                <li style="width: 20%;" class="money"><?php echo ($v["jb"]); ?></li>
                <li style="width: 20%;"><a href="/Index.php/Home/Info/del/?id=<?php echo ($v["id"]); ?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">取消</a></li>
                <li style="width: 18%;">
                    <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                    <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                    <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #05B6A3;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
...
<div id="zzjy" style="display:none;margin-bottom:80px;">
    <div>
        ...
        <ul class="myjy_head"style="font-weight: 700">
            ...
            <li style="width: 15%">等级</li>
            <li style="width: 35%">GEC</li>
            <li style="width: 20%">价格($)</li>
        </ul>
	...
	<?php if(is_array($lists)): foreach($lists as $key=>$v): ?><ul class="myjy_body">
            <li style="width: 10%;"><input type="radio" name="xz"checked class="xz" value="<?php echo ($v["id"]); ?>" for="xxx"/></li>
            <li style="width: 20%;height: 30px;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space: nowrap;"><?php echo ($v["g_name"]); ?></li>
            <li class=" iconfont" style="width: 15%; font-size:12px" >
						<?php if($v["p_level"] == 0): ?>未激活<?php endif; ?>
						<?php if($v["p_level"] == 1): ?>GEC矿工<?php endif; ?>
						<?php if($v["p_level"] == 2): ?>工会会长<?php endif; ?>
						<?php if($v["p_level"] == 3): ?>创业大使<?php endif; ?>
						<?php if($v["p_level"] == 4): ?>环保大使<?php endif; ?>
						<?php if($v["p_level"] == 5): ?>国际大使<?php endif; ?>
				
			</li>
            <li style="width: 35%"><?php echo ($v["lkb"]); ?></li>
            <li style="width: 20%" class="money"><?php echo ($v["jb"]); ?></li>
        </ul><?php endforeach; endif; ?>
    ...
    <table class="jyzx_list" style="margin-top:60px;border-collapse:collapse;width:90%;margin-left:5%">
        ...
        <tbody >
		 <?php if(is_array($oob)): foreach($oob as $key=>$s): ?><tr>
            <td style="height:30px;line-height:30px;padding-left:10px;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space: nowrap;"><?php echo ($s["p_name"]); ?></td>
            <td style="height:30px;line-height:30px;text-align:center;font-size:12px; "class=" iconfont">
						...
						<?php if($s["p_level"] == 3): ?>创业大使<?php endif; ?>
						<?php if($s["p_level"] == 4): ?>环保大使<?php endif; ?>
						<?php if($s["p_level"] == 5): ?>国际大使<?php endif; ?>
