	...
	public function tuiguangma(){
        ...
        $matrixPointSize = intval($size);//生成图片大小
		 ...
		 $path = "Public/code/";
			...
			$img->open('./Public/code/card.jpg')->water($fileName, array(150,538))->text($name,'./Public/code/hei.ttf','20','#d53917', array(-255,-970))->save($fileName);
		
		
		//print_r($fileName);die;
		$this->assign('code', 'http://' .$_SERVER['HTTP_HOST'].'/'.$fileName);
		$this->assign('url', $url);
