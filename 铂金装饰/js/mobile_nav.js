...
function(y, e) {
    ...
    P = (a = y("head"), l = "hc-mobile-nav-style",
    function(e) {
        ...
        hcMobileNav: function(e) {
            ...
            return this.each(function() {
                ...
                if (o.length) {
                    ...
                    v = "hc-nav-" + ++S;
                    e.addClass("hc-nav " + v),
                    m.customToggle ? i = y(m.customToggle).addClass(v).on("click", u) : (i = y('<a class="hc-nav-trigger ' + v + '"><span></span></a>').on("click", u), e.after(i));
                    ...
                    if (m.maxWidth && (t = "@media screen and (max-width: " + (m.maxWidth - 1) + "px) {\n            " + t + "\n          }"), P(t), n.on("click", B).removeAttr("id").removeClass().addClass("\n            hc-mobile-nav\n            " + v + "\n            " + (m.navClass || "") + "\n            nav-levels-" + (m.levelOpen || "none") + "\n            side-" + m.side + "\n            " + (m.offCanvas ? "off-canvas": "") + "\n            " + (m.disableBody ? "disable-body": "") + "\n            " + (T ? "is-ios": "") + "\n            " + (w ? "touch-device": "") + "\n          ").find("[id]").removeAttr("id"), m.disableBody && n.on("click", h), m.closeOnClick && o.find("li").children("a").on("click", h), !1 !== m.insertClose) {
                        ...
                        !0 === m.insertClose ? o.first().prepend(s) : O(m.insertClose) && N(s, m.insertClose, o.first().add(o.siblings("ul")))
                    }
                    o.each(function() {
                        var e = y(this),
                        ...
                        if (0 !== n) {
                            ...
                            if (!m.levelSpacing || "expand" !== m.levelOpen && !1 !== m.levelOpen && "none" !== m.levelOpen || e.css("text-indent", m.levelSpacing * n + "px"), !1 === m.levelOpen || "none" === m.levelOpen) return; ! 0 === m.levelTitles && i.prepend("<h2>" + l.text() + "</h2>");
                ...
                function d() {
                    ...
                    o.prop("checked") ? (n = t, a = p[e = i][n].checkbox.parent("li"), (l = p[e][n].wrapper).addClass("sub-level-open"), a.addClass("level-open"), "overlap" === m.levelOpen && (l.on("click",
                    function() {
                        return g(e, n)
                ...
                function f() {
                    ...
                    m.disableBody && (l = k.scrollTop() || b.scrollTop(), b.addClass("hc-nav-open"), l && b.css("top", -l), x.body.scrollHeight > x.body.offsetHeight && k.addClass("hc-yscroll"))
                }
                function h() {
                    a = !1,
                    ...
                    m.disableBody && (b.removeClass("hc-nav-open"), k.removeClass("hc-yscroll"), l && (b.css("top", "").scrollTop(l), k.scrollTop(l), l = 0))
                }
                function u(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                ...
                function g(e, n) {
                    for (var a = e; a <= Object.keys(p).length; a++) {
                        if (0 !== a) if (a == e && void 0 !== n) {
                            if (c(a, n), "overlap" === m.levelOpen) p[a][n].wrapper.off("click").on("click", B),
                            C(r, (a - 1) * m.levelSpacing)
                        } else for (var l in p[a]) {
                            if (c(a, l), "overlap" === m.levelOpen) p[a][l].wrapper.off("click").on("click", B),
