...
(function(e) {
    ...
    e.extend(y, {
        ...
        F: function(d, c, a) {
            ...
            g,
            t;
            if (0 === m.d || 0 === m.b) e(new Image).on('load',
            function() {
                f.F(d, c)
            }).attr("src", d.attr("src"));
            else {
                ...
                g.mouseover(function(a) {
                    ...
                    clearTimeout(f.a.n);
                    clearTimeout(f.a.o);
                    b.j !== g.data("largeimage") && (e(new Image).on('load',
                    function() {}).attr("src", b.j), e(g).unbind(), e(n).remove(), e(q).remove(), e(u).remove(), e(g).remove(), e(t).remove(), f.F(d, c, k));
                ...
                function() {
                    ...
                    function(a, e) {
                        if ("error" !== e.type) {
                            ...
                            g.data("loadevt", k);
                            b.zoomrange && b.zoomrange[1] > b.zoomrange[0] ? g.bind("mousewheel",
                            function(a, c) {
                                var d = l.k,
